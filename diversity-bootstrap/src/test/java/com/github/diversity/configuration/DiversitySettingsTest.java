...
import static com.github.diversity.unit.CustomMatcher.*;
...
public class DiversitySettingsTest {

	private static final String ROOT_DIR= "./src/test/fixture/configuration";
	
	private DiversitySettings buildSettings;
	...
	public void setUp() {
		...
		this.buildSettings = new DiversitySettings(properties);
	}
